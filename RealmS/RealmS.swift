...
//			}
  ...
  /**
   ...
   Write transactions cannot be nested.
  ...
  /**
   ...
   Calling this when not in a write transaction will return an error.

   - returns: An commit `NSError` object.
   */
...
/*
 ...
 - params lhs: left object
 - params rhs: right object
 - returns: `true` if `lhs` is equal `rhs`
 */
